...
set ncc_reason "Va faire tes CTCP ailleurs..."
...
set ncc_warning "Chan ctcps sont interdit sur %chan."
...
set dowhat ""
	if {[string tolower $nick] != [string tolower $botnick]} {
		...
		putlog "Anti CTCP canal: $nick ($uhost) requested channel ctcp from $chan"
	}
}
...
putlog "TCL loaded: nochanctcps.tcl v$ncc_ver by Sup <temex@iki.fi> Chargé"